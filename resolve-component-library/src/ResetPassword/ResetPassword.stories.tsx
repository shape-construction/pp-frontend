...
export default {
  title: 'Panels/ResetPassword',
  component: ResetPassword,
  args: {
    logInLink: 'login',
    logo,
  },
} as Meta<ResetPasswordProps>;

const TemplateResetPassword: Story<ResetPasswordProps> = (args) => <ResetPassword {...args} />;

export const Default = TemplateResetPassword.bind({});

export const WithFields = TemplateResetPassword.bind({});
WithFields.args = {
  fieldsValues: {
...
export const WithFieldErrors = TemplateResetPassword.bind({});
...
export const WithFeedback = TemplateResetPassword.bind({});
WithFeedback.args = {
