...
import { FeedbackPanel, FeedbackPanelProps } from './FeedbackPanel';
...
export default {
  title: 'Panels/FeedbackPanel',
  component: FeedbackPanel,
} as Meta<FeedbackPanelProps>;

const TemplateFeedbackPanel: Story<FeedbackPanelProps> = (args) => <FeedbackPanel {...args} />;

export const Default = TemplateFeedbackPanel.bind({});
Default.args = {
...
export const ForgotPassword = TemplateFeedbackPanel.bind({});
ForgotPassword.args = {
  footer: (
    <>
