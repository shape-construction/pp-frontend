...
export default {
  title: 'Panels/ForgotPassword',
  component: ForgotPassword,
  args: {
    logInLink: 'Log in',
    logo,
  },
} as Meta<ForgotPasswordProps>;

const TemplateForgotPassword: Story<ForgotPasswordProps> = (args) => <ForgotPassword {...args} />;

export const Default = TemplateForgotPassword.bind({});
Default.args = {};

export const WithFields = TemplateForgotPassword.bind({});
WithFields.args = {
  fieldsValues: {
...
export const WithFieldErrors = TemplateForgotPassword.bind({});
...
export const WithFeedback = TemplateForgotPassword.bind({});
WithFeedback.args = {
